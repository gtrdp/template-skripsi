...
\chapter{HASIL DAN PEMBAHASAN}
		...
		\subsection{\emph{Screenshot} Aplikasi}
			...
			\begin{itemize}
				...
				\item Halaman \emph{dashboard} saat peranti sudah terpasang.
					...
					\begin{figure}[ht!]
					  \centering
					    \includegraphics[width=0.3\textwidth]{gambar/dashboard-full}
					    \caption{Halaman \emph{dashboard} saat peranti sudah terpasang.}
					    \label{add-iqrf}
					\end{figure}
				\item Halaman \emph{dashboard} saat peranti sudah terpasang (dibuka di layar kecil).
				\item Halaman daftar peranti IQRF yang terpasang.
				\item Halaman daftar peranti XBee yang terpasang.
				\item Halaman untuk menambahkan peranti IQRF.
				\item Halaman untuk menambahkan peranti XBee.
				\item Halaman untuk menambahkan profil.
				\item Halaman yang menampilkan daftar pengguna.
				\item Halaman untuk menambahkan pengguna baru.
				\item Halaman login.
			\end{itemize}
	...
	\section{Analisis Unjuk Kerja Aplikasi}
		...
		\subsection{Masalah dan Penyelesaian}
			...
			Pyserial
			Extroot harus direstart dulu sebelum bisa berjalan.
