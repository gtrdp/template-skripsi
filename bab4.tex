	...
	\section{Pengembangan Aplikasi}
		...
		\subsection{Pengembangan Aplikasi Python}
			...
			\subsubsection{\emph{Profiling}}\
				...
				\begin{figure}[ht!]
				  \centering
				    \includegraphics[width=0.7\textwidth]{gambar/python-profile}
		...
		\subsection{Pengembangan Aplikasi Berbasis Web}
			...
			Antarmuka yang dikembangkan adalah hasil \emph{fork} dari \emph{template} halaman administrator buatan Vince G \cite{Gabriel2013}. Antarmuka ditulis menggunakan HTML5 dan CSS3, dengan tambahan pemrograman JavaScript pada sisi klien agar menambah interaktivitas. Pustaka Bootstrap digunakan untuk membuat halaman web menjadi responsif, sehingga dapat menyesuaikan diri secara otomatis sesuai dengan ukuran layar. Pustaka jQuery digunakan untuk membantu pemrograman di sisi klien, sedangkan kode sumber untuk aplikasi berbasis web ditulis dengan bantuan Sublime Text 3.
